    ...
    <body>
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-4 col-xl-3">
                  ...
                  <a href="{{route('users.index')}}" class="card bg-c-blue order-card">
                      <div class="card-block">
                          ...
                          <h2 class="text-right"><i class="fa fa-map-marker fa-lg f-left"></i><span>{{$user}}</span></h2>
              ...
              <div class="col-md-4 col-xl-3">
                  <a  href="{{route('messages.index')}}" class="card bg-c-green order-card">
                      <div class="card-block">
                          ...
                          <h2 class="text-right"><i class="fa fa-pagelines fa-lg f-left"></i><span>{{$messages}}</span></h2>
              ...
              <div class="col-md-4 col-xl-3">
                  <a href="{{route('users.index')}}" class="card bg-c-yellow order-card">
                      <div class="card-block">
                          <h6 class="m-b-20">Text Messages</h6>
                          <h2 class="text-right"><i class="fa fa-leaf fa-lg f-left"></i><span>{{$text}}</span></h2>
              ...
              <div class="col-md-4 col-xl-3">
                  <a href="{{route('users.index')}}" class="card bg-c-pink order-card">
                      <div class="card-block">
                          <h6 class="m-b-20">Document Attachments</h6>
                          <h2 class="text-right"><i class="fa fa-globe f-left"></i><span>{{$docs}}</span></h2>
                          <p class="m-b-0">Views Available<span class="f-right">1</span></p>
                      </div>
                  </a>
              </div>
